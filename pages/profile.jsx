                ...
                <div className="menuRightMarginShift">
                    ...
                    <div className="row">
                        <div className="col-6">
                            ...
                            <button type="button" class="btn btn-success" style={{ fontSize: "14px" }}>Unclock With Nitro</button>
                            <hr style={{ height: "2px", background: "gray", marginTop: "35px", width: "100%" }} />
                            ...
                            <textarea style={{ width: "100%", height: "150px", background: "#202225" }}></textarea>
                        ...
                        <div className="col-6">
                            ...
                            <div class="card" style={{ border: "0" }}>
                                <div class="card-body p-0 m-0 bg-dark">
                                    <h5 class="card-title bg-secondary p-4"><br /></h5>
                                    ...
                                    <h5 class="card-subtitle mb-2 text-white pt-3 px-2" style={{ fontWeight: "600" }}>Username<span style={{ color: '#B9BBBE' }}>#1024</span></h5>
                                    <h6 class="card-subtitle mb-2 pt-2 px-2" style={{ fontSize: "14px", fontWeight: "600", color: "#B9BBBE" }}>CUSTOMISING MY PROFILE</h6>
                                    <div className="row px-2 mb-2 text-center">
                                        ...
                                        <div className="col-xl-7 col-xxl-8">
                                            <h6 class="card-subtitle mb-2 pt-3 px-2" style={{ fontSize: "14px", fontWeight: "600", color: "#B9BBBE" }}>User Profile</h6>
                                            <h6 class="card-subtitle mb-2 px-2" style={{ fontSize: "14px", fontWeight: "600", color: "#B9BBBE" }}>3:36 elapsed</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
